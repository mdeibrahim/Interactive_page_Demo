...
urlpatterns = [
    ...
    path('categories/<slug:cat_slug>/details/<slug:course_slug>/', api_views.DetailRetrieveAPIView.as_view(), name='api_detail_retrieve'),
    path('categories/<slug:cat_slug>/details/<slug:course_slug>/buy/', api_views.BuyDetailAPIView.as_view(), name='api_buy_detail'),
